...
Files\php.exe GenPHPInstaller.wxs.php "PHPInstallerBase%phpver%.wxs" "%1"

echo Building WebServerConfig%1.wxs
copy WebServerConfig%phpver%.wxs WebServerConfig%1.wxs
...
Wix\light.exe -out "php-%1-win32-installer.msi" ExtensionsComponents.wixobj ExtensionsFeaturesBuild.wixobj WebServerConfig%1.wixobj PHPInstaller%1.wixobj PHPInstallerCommon.wixlib -loc WixUI_en-us.wxl
